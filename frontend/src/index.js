 ...
 * This prevents the "Double-Action" bug where walletextensions (Leather/Xverse)
 * are triggerd twice, causing "Ka is not a function" or "Signature Request Denied" errors.
 */
root.render(
    <App />
);