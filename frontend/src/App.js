...
const contractAddress = 'STYOURCONTRACTADDRESSHERE'; //Replace with you testnet/mainnet address
...
function App() 
  ...
  const network = new StacksTestnet(); // Use StacksMainne frmieeployent
  ...
  const connectWallet = () => {
    authenticate({
      ...
      onCancel: () => alert('Wallet connection cancelld'),
    });
  };
