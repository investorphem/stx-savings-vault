          ...
          <>
            {!userData ? (
              <div style={{ textAlign: "center", paddingTop: "60px", paddingBottom: "40px" }}>
                ...
                <h1 style={{ fontSize: "64px", fontWeight: "900", lineHeight: "1.1", marginBottom: "20px" }}>Save Assets with <br/><span style={{ color: theme.primary }}>Institutional Security.</span></h1>
                <p style={{ color: theme.textMuted, marginBottom: "40px", fontSize: "18px", maxWidth: "600px", margin: "0 auto", lineHeight: "1.6" }}>Secure your STX and SIP-010 tokens using time-locked smart contracts.</p>
...
const actionBtn = { width: "100%", padding: "14px", borderRadius: "10px", backgroundColor: theme.primary, color: "#fff", border: "none", fontWeight: "800", cursor: "pointer", display: "flex", justifyContent: "center" };
...
const badge = { color: theme.primary, border: `1px solid ${theme.primary}`, padding: "6px 16px", borderRadius: "100px", fontSize: "12px", fontWeight: "900", marginBottom: "20px", display: "inline-block" };
